#!/bin/bash
# Fetch timetable details from AIMS
...
# Example: fetch timetable for course ID 17225
COURSE_ID="${1:-17225}"
...
curl 'https://aims.iith.ac.in/aims/courseReg/getStdntRngCrsTimeTableDtls' \
  ...
  --data-raw "dataObj=%7B%22runningCourseIds%22%3A%22$COURSE_ID%22%2C%22studentId%22%3A%22$AIMS_STUDENT_ID%22%7D"